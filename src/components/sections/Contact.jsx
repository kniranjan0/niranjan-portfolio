...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('https://formsubmit.co/ajax/kniranjan682@gmail.com', {
        method: 'POST',
        ...
        <div className="row contact-grid">
          <div className="contact-left">
            ...
            <div className="contact-cards gradient-card">
              <a className="contact-card" href="mailto:kniranjan682@gmail.com">
                <div className="icon"><i className="fas fa-paper-plane" aria-hidden="true"></i></div>
                <div className="content">
                  <div className="label">Email</div>
                  <div className="value">kniranjan682@gmail.com</div>
                </div>
              </a>
              <a className="contact-card" href="tel:9903149299">
                ...
                <div className="content">
                  ...
                  <div className="value">+91 95255 09887 </div>
                </div>
              </a>
            </div>

            <div className="contact-social">
              <a href="https://github.com/kniranjan0" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile">
                <i className="fab fa-github" />
              </a>
              <a href="https://www.linkedin.com/in/niranjan-kumar682/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile">
                <i className="fab fa-linkedin" />
              </a>
            </div>

            <a
              href="https://drive.google.com/uc?export=download&id=1u082K0DxqDNs5sQFAqYnSLV15tSw9rnM"
              target="_blank"
