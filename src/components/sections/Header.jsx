    ...
    <header id="header">
      <div className="container">
        ...
        <div className="header-content hero">
          <div className="hero-left">
            <div className="header-text">
              ...
              <h1 className="name">Niranjan <span>Kumar</span></h1>
        ...
        <div className="header-social">
          <a href="https://github.com/kniranjan0" target="_blank" rel="noopener noreferrer" className="social-link">
            <i className="fab fa-github"></i>
          </a>
          <a href="https://www.linkedin.com/in/niranjan-kumar682/" target="_blank" rel="noopener noreferrer" className="social-link">
